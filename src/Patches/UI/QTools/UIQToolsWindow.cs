    ...
    public class UIQToolsWindow : ManualBehaviour
    {
        ...
        private void CreateUI()
        {
            ...
            _recipeMachines = new Dictionary<Utils_ERecipeType, ItemComboBox>
            {
                ...
                [Utils_ERecipeType.位面熔炉] = MyComboBox.MyComboBox.CreateComboBox<ItemComboBox>(430, 110, _tabs[0]),
                [Utils_ERecipeType.Assemble] = MyComboBox.MyComboBox.CreateComboBox<ItemComboBox>(30, 155, _tabs[0]),
                [Utils_ERecipeType.太空船坞] = MyComboBox.MyComboBox.CreateComboBox<ItemComboBox>(430, 155, _tabs[0]),
                [Utils_ERecipeType.粒子打印] = MyComboBox.MyComboBox.CreateComboBox<ItemComboBox>(30, 200, _tabs[0]),
