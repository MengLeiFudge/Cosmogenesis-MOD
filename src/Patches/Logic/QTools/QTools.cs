...
namespace ProjectGenesis.Patches.Logic.QTools
{
    internal static class QTools
    {
        ...
        private static ConcurrentDictionary<Utils.ERecipeType, List<ItemProto>> GetFactoryDict()
        {
            ...
            foreach (ItemProto proto in items)
            {
                ...
                switch (filter)
                {
                    ...
                    case Utils.ERecipeType.所有熔炉:
                    {
                        ...
                        dict.TryAddOrInsert(Utils.ERecipeType.位面熔炉, proto);
                    ...
                    case Utils.ERecipeType.物质重组:
                    {
                        ...
                        dict.TryAddOrInsert(Utils.ERecipeType.粒子打印, proto);
                        dict.TryAddOrInsert(Utils.ERecipeType.物质重组, proto);
                    ...
                    {
                        dict.TryAddOrInsert(Utils.ERecipeType.Assemble, proto);
                        dict.TryAddOrInsert(Utils.ERecipeType.太空船坞, proto);
            ...
            //dict.TryAddOrInsert(Utils.ERecipeType.粒子打印, itemProto);
